...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form role="form" action="AdminLogin_script.php" method="POST">
        ...
        <div><b style="color:red;margin-left:">
                        <?php
                        if(isset($_GET["err"])){
                          echo $_GET['err'];
                        }
      ...
      <input type="password" id="password" placeholder="Enter your password" name = "password" class="form-control" required>
        ...
        <div><b style="color:red;margin-left: -2px;margin-top:10px">
                        <?php
                        if(isset($_GET["error"])){
                          echo $_GET['error'];
                        }
      ...
      <p class="mb-1">
        <a href="forgetPasswordAdmin.php">forgot your password?</a>
      </p>
      <p class="mb-0">
