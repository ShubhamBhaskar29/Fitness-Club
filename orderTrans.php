...
<div class="container">
    ...
    <div class="card" style="margin-left:-10px;width:1230px;">
              <div class="card-header" style="margin-left:0px;;">
                <h3 style="font-weight:bold" class="card-title">Payment List</h3>
              </div>
              <!-- /.card-header -->
    ...
    <?php
    $x = 0;
    $sql = "SELECT * FROM order_payment ORDER BY id DESC";
    ...
    //    echo '$image';
      ...
      echo '<td>'.$email.'</td>';
      echo '<td>'.$pnumber.'</td>';
      echo '<td style="width:500px">'.$address.'</td>';
    
      echo '<td style="width:500px">'.$totalprice.'</td>';
